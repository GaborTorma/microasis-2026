...
export const privacyContent = {
  ...
  "sections": [
    ...
    },
    {
      "headingHu": "Kapcsolat",
      "headingEn": "Contact",
      "bodyHu": "Az alkalmazást Torma Gábor készíti függetlenül, és nem a fesztivál jogi szervezete. Adatvédelmi kérdésekkel kapcsolatban írj a microasis2026@torma.ai címre.",
      "bodyEn": "This app is made independently by Gabor Torma and is not the festival legal entity. For any privacy questions, contact microasis2026@torma.ai."
    }
  ],
  "contactHu": "Adatvédelmi kérdésekkel fordulj a fejlesztőhöz, Torma Gáborhoz: microasis2026@torma.ai. Ez egy nem hivatalos, rajongók által készített alkalmazás, amely nem áll kapcsolatban a MicrOasis fesztivállal vagy szervezőivel, és nem azok támogatásával vagy jóváhagyásával készült.",
  "contactEn": "For privacy questions, contact the developer, Gabor Torma, at microasis2026@torma.ai. This is an unofficial, fan-made app and is not affiliated with, endorsed by, or sponsored by the MicrOasis festival or its organizers."
} as const;

export const supportContent = {
  "lastUpdated": "2026-06-23",
  "introHu": "Üdv a Guide for MicrOasis 2026 támogatási oldalán! Ez egy rajongói kalauz, amely az egész fesztivál időrendjét a zsebedben tartja: böngészd a műsort színpadokra bontva, nézd meg, mi szól éppen most, és vidd magaddal az Apple Watch-odon is. Lent megtalálod a leggyakoribb kérdéseket – ha valami mégis kimaradt, írj nekünk bátran.",
  "introEn": "Welcome to the support page for Guide for MicrOasis 2026! This is a fan-made companion that keeps the whole festival timetable in your pocket: browse the line-up stage by stage, see what's playing right now, and take it with you on your Apple Watch. Below you'll find the most common questions – and if anything's missing, just drop us a line.",
  "aboutHu": "A Guide for MicrOasis 2026 egy ingyenes, rajongók által készített kalauz a magyarországi MicrOasis 2026 fesztiválhoz (2026. augusztus). Megmutatja a teljes időrendet minden színpadon (Oasis, Wadi, Yoga Terrace), tartalmaz egy „Most” nézetet, ami kiemeli, mi szól éppen és mi következik, valamint egy beépített Apple Watch-alkalmazást és Smart Stack widgeteket. Ingyenes, reklámmentes, nincs benne alkalmazáson belüli vásárlás, és nem kér regisztrációt vagy bejelentkezést. Az első betöltés után offline is működik. Minden időpont Európa/Budapest idő szerint jelenik meg.\n\nFontos: ez egy NEM HIVATALOS, rajongói alkalmazás. Nem áll kapcsolatban a MicrOasis fesztivállal vagy annak szervezőivel, nem ők készítették, nem támogatják és nem szponzorálják. Minden védjegy a jogtulajdonosát illeti; a fesztivál nevét kizárólag hivatkozás (megnevezés) céljából használjuk. A fejlesztő Torma Gábor, független magánszemély – nem a fesztivál jogi entitása.",
  "aboutEn": "Guide for MicrOasis 2026 is a free, fan-made companion for the MicrOasis 2026 festival in Hungary (August 2026). It shows the full timetable across every stage (Oasis, Wadi, Yoga Terrace), a \"Now\" view that highlights what's playing and what's up next, plus a built-in Apple Watch app and Smart Stack widgets. It's free, ad-free, has no in-app purchases, and asks for no account or sign-in. It works offline after the first load, and all times are shown in Europe/Budapest time.\n\nImportant: this is an UNOFFICIAL, fan-made app. It is not affiliated with, endorsed by, or sponsored by the MicrOasis festival or its organizers, and was not made by them. All trademarks belong to their respective owners; the festival's name is used purely for reference (to say what the app is a guide for). The developer is Gábor Torma, an independent individual – not the festival's legal entity.",
  "faq": [
    {
    ...
    },
    {
      ...
      "aHu": "Az időrendet az alkalmazás csak olvasásra, HTTPS-en keresztül tölti le (https://microasis.torma.ai/api/schedule), és a készüléken tárolja. Nincs analitika, nincs követés, nincsenek harmadik féltől származó SDK-k, és semmilyen személyes adatot nem gyűjtünk vagy küldünk a készülékről. Nincs fiók, nincs bejelentkezés.",
      "aEn": "The timetable is fetched read-only over HTTPS (https://microasis.torma.ai/api/schedule) and cached on your device. There's no analytics, no tracking, no third-party SDKs, and no personal data is collected or sent off your device. No account, no sign-in."
    },
    {
    ...
    {
      "qHu": "Ez a hivatalos MicrOasis-alkalmazás?",
      "qEn": "Is this the official MicrOasis app?",
      "aHu": "Nem. Ez egy független, rajongói kalauz, amelyet egy magánszemély készített. Nem áll kapcsolatban a MicrOasis fesztivállal vagy szervezőivel, és azok nem támogatják. A fesztivál nevét csak azért használjuk, hogy elmondjuk, mihez készült a kalauz.",
      "aEn": "No. This is an independent, fan-made guide built by a private individual. It is not affiliated with or endorsed by the MicrOasis festival or its organizers. We use the festival's name only to say what the guide is for."
    },
    {
      "qHu": "Hogyan érem el a támogatást?",
      "qEn": "How do I contact support?",
      "aHu": "Kérdés, hibajelzés vagy javaslat esetén írj e-mailt a microasis2026@torma.ai címre. Szívesen fogadjuk a visszajelzést, és igyekszünk hamar válaszolni. Ha hibát jelentesz, segít, ha leírod, milyen készüléken (iPhone vagy Apple Watch) és melyik nézetben tapasztaltad.",
      "aEn": "For questions, bug reports, or suggestions, email microasis2026@torma.ai. We welcome feedback and try to reply quickly. When reporting a bug, it helps to mention which device (iPhone or Apple Watch) and which view you saw it in."
    }
  ],
  "contactEmail": "microasis2026@torma.ai"
} as const;
